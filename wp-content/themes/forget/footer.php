...
<?php $options=get_option('f_options'); ?>
 <footer id="m-footer">
   <div class="Copyright">
     <p><?php if($options["footer"]): ?><?php echo $options['footer']; ?><?php else :?>©2015 <?php bloginfo('name');?>.All Rights Reserved.Theme by <a href="http://azfashao.com/">发烧</a><?php endif; ?></p>
   </div>
 </footer>
...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?ba2c95a903484682559ed505b960665e";
