...
function mp3player3($atts, $content=null){
	...
	return '<div class="lrcplay"><div class="statusinfo"><span id="lrcicon-play" class="lrcicon-play"></span>'.$name.'</div><audio id="'.$id.'" src="'.$content.'" name="playerd" class="playerd"></audio></div>';  
}
add_shortcode('mp3','mp3player3');  //mp3可以改成你想设置的其他短代码,只要不冲突即可  
